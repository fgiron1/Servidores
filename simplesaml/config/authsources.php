...
$config = [
	...
	'certificate' => 'sp.crt',
        ...
        'idp' => 'https://idpserver.westeurope.cloudapp.azure.com',
    ...
    'example-sql' => [
        'sqlauth:SQL',
        'dsn' => 'sqlsrv:Server=identidades.database.windows.net;Encrypt=1;TrustServerCertificate=0;Database=Identidades',
        'username' => 'SPLogin',
        'password' => '+2uF#e9aY4rT-2RC',
        'query' => 'SELECT id, NIF_hash, haVotado FROM Cuentas_usuario WHERE NIF_hash = :username ' .
            'AND password_hash = :password AND haVotado = 0',
    ]
