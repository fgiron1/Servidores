...
$config = [
     ...
     * reverse proxy).
     */
    'baseurlpath' => 'https://spserver.westeurope.cloudapp.azure.com/simplesaml/',
     ...
     */
    'secretsalt' => 'gte1e6topo9nnidyu5xq9sxqzwfj6k41',
     ...
     */
    'auth.adminpassword' => 'igetowned.999.',
     ...
     */
    'database.dsn' => 'sqlsrv:Server=identidades.database.windows.net;Encrypt=1;TrustServerCertificate=0;Database=Identidades',

    /*
     * SQL database credentials
     */
    'database.username' => 'IdPLogin',
    'database.password' => '+2uF#e9aY4rT-2RC',
    'database.options' => [],
