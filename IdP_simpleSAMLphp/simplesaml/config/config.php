...
$config = [
     ...
     * reverse proxy).
     */
    'baseurlpath' => 'https://idpserver.westeurope.cloudapp.azure.com/simplesaml/',
     ...
     */
    'auth.adminpassword' => 'masterlink999',
     ...
     */
    'database.dsn' => 'identidades.database.windows.net;Encrypt=1;TrustServerCertificate=0;Database=Identidades',

    /*
     * SQL database credentials
     */
    'database.username' => 'IdPLogin',
    'database.password' => 'p<!c.9^M2Y`DZD4K',
    'database.options' => [],
